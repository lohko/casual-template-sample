  ...
  <MDBCol lg="3" md="6" className="mb-lg-0 mb-5 pt-3">
    <MDBView hover className="flex-center">
      ...
      <MDBMask className="flex-center">
        <img tag="img" src={batman} className="img-fluid" alt="Sample avatar" />
      </MDBMask>
    </MDBView>
    <h5 className="font-weight-bold mb-3">Esimerkki Työntekijä</h5>
    <p className="text-uppercase blue-text">Työnimike</p>
  </MDBCol>
);
